...
Ext.define('Engine.model.Topic', {
    ...
    set: function(name, value) {
        if (Ext.Array.contains(Engine.model.Topic.persistableFields, name)) {
            ...
            if (changed) {
                ...
                topicsStore.fireEvent('textchanged', topicsStore, this, oldValue, value);
            }
        }
    ...
    getFilePath: function() {
        return Engine.Global.dataContentPath + this.get('fileId') + '.html';
    }
});